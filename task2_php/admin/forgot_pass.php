...
<body id="myDiv" style="background-color:aquamarine;">   
<div class="wrapper fadeInDown">
    ...
    ?>
      ...
      <form name="register" action="forgot_proce.php" method="POST">
        <input type="text" id="email" class="fadeIn second" name="txtemail" placeholder="Email">
        <input type="password" id=" " class="fadeIn third" name="confpassword" placeholder="Confirm Password">
        <input type="password" id="password" class="fadeIn third" name="txtpassword" placeholder="Password">
      
        <input type="submit" class="fadeIn fourth" value="Reset New Password">
      </form>
